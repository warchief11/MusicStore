...
{
    public partial class Configuration : DbMigrationsConfiguration<MusicStore.DAL.Models.MusicStoreContext>
    {
        ...
        private static void AddAlbums(MusicStoreContext context, List<Genre> genres, List<Artist> artists)
        {
        ...
        private static List<Artist> AddArtists(MusicStoreContext context)
        {
        ...
        private static List<Genre> AddGenres(MusicStoreContext context)
        {
